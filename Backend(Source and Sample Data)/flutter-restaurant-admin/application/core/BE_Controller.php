...
class BE_Controller extends PS_Controller {
	...
	*/
	 ...
	 * Index
	*/
	function additional_index($food_id=false)
	{
		$this->additional_list_view( $this->module_site_url( 'index' ),$food_id);
	}

	/**
	 * Search
	 */
	function additional_search($food_id=false)
	{
		$this->additional_list_view( $this->module_site_url( 'search' ), $food_id);	
	}
	...
	*/
	 ...
	 * @param      <type>  $base_url  The base url
	 */
	function additional_list_view( $base_url , $food_id=false)
	{
		// pagination
		$rows_count = $this->data['rows_count'];
		$this->load_pag( $base_url, $rows_count );
		...
		// load add list
		$this->load_list_additional( $this->data );
	}
	 ...
	 * Add a new record
	 */
	function add_additional($product_id = 0)
	{
		...
		// load entry form
		$this->load_additional_form( $this->data );
	}
	 ...
	 * Edit the exiting record
	 */
	function additional_edit( $id ,$food_id = 0 )
	{
